...
namespace GenDoc.Classes.Env
{
    static class Settings
    {
        ...
        public const string PageTemplateFileNameDev = @"D:\WORK\RentACoder\James\Work\Doc\DocWebSite\template\page-template-dev.html";
        ...
        public const string OutDir = @"D:\WORK\RentACoder\James\Work\Doc\DocWebSite\jsgui-doc\content"; // user version
        public const string DevOutDir = OutDir + "-dev";  // jsgui developer's doc work version
